...
IF(NOT DEFINED _PACK_SOURCE_CMAKE_)
    ...
    MACRO(PACK_SOURCE version outputDir)
	IF(${ARGV3})
	...
	#IF (_ignore STREQUAL "")
	#    SET(CPACK_SOURCE_IGNORE_FILES ${PACK_SOURCE_IGNORE_FILES} CACHE INTERNAL "CPACK_SOURCE_IGNORE_FILES")
	#ELSE(_ignore STREQUAL "")
	#    SET(CPACK_SOURCE_IGNORE_FILES ${_ignore} CACHE INTERNAL "CPACK_SOURCE_IGNORE_FILES")
	#ENDIF(_ignore STREQUAL "")
	SET(CPACK_SOURCE_PACKAGE_FILE_NAME "${outputDir}/${PROJECT_NAME}-${version}-Source")
